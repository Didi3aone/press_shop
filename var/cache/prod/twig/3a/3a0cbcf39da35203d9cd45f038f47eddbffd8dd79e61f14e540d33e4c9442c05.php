...
(isset($context["origin"]) || array_key_exists("origin", $context))) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none")))));
    ...
    {
        return new Twig_Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_configure.html.twig", "/var/www/html/press_shop/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/grid_notification_configure.html.twig");
    }
}
